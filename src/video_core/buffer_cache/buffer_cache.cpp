...
std::pair<Buffer*, u32> BufferCache::ObtainBuffer(VAddr device_addr, u32 size, bool is_written,
    ...
    // Only stream-copy if CPU actually modified this region since last upload.
    // Games re-bind the same UBOs hundreds of times per frame — skipping unchanged
    // ones eliminates redundant vkCmdCopyBuffer PCIe traffic.
